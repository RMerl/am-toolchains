...
#define HAVE_CC_Cmode
  CC_DNEmode,              /* config/aarch64/aarch64-modes.def:29 */
#define HAVE_CC_DNEmode
  CC_DEQmode,              /* config/aarch64/aarch64-modes.def:30 */
#define HAVE_CC_DEQmode
  CC_DLEmode,              /* config/aarch64/aarch64-modes.def:31 */
#define HAVE_CC_DLEmode
  CC_DLTmode,              /* config/aarch64/aarch64-modes.def:32 */
#define HAVE_CC_DLTmode
  CC_DGEmode,              /* config/aarch64/aarch64-modes.def:33 */
#define HAVE_CC_DGEmode
  CC_DGTmode,              /* config/aarch64/aarch64-modes.def:34 */
#define HAVE_CC_DGTmode
  CC_DLEUmode,             /* config/aarch64/aarch64-modes.def:35 */
#define HAVE_CC_DLEUmode
  CC_DLTUmode,             /* config/aarch64/aarch64-modes.def:36 */
#define HAVE_CC_DLTUmode
  CC_DGEUmode,             /* config/aarch64/aarch64-modes.def:37 */
#define HAVE_CC_DGEUmode
  CC_DGTUmode,             /* config/aarch64/aarch64-modes.def:38 */
...
#define HAVE_TImode
  EImode,                  /* config/aarch64/aarch64-modes.def:52 */
#define HAVE_EImode
  OImode,                  /* config/aarch64/aarch64-modes.def:48 */
#define HAVE_OImode
  CImode,                  /* config/aarch64/aarch64-modes.def:53 */
#define HAVE_CImode
  XImode,                  /* config/aarch64/aarch64-modes.def:54 */
#define HAVE_XImode
...
#define HAVE_DFmode
  TFmode,                  /* config/aarch64/aarch64-modes.def:67 */
#define HAVE_TFmode
...
#define HAVE_TCmode
  V8QImode,                /* config/aarch64/aarch64-modes.def:41 */
#define HAVE_V8QImode
  V4HImode,                /* config/aarch64/aarch64-modes.def:41 */
#define HAVE_V4HImode
  V2SImode,                /* config/aarch64/aarch64-modes.def:41 */
#define HAVE_V2SImode
  V16QImode,               /* config/aarch64/aarch64-modes.def:42 */
#define HAVE_V16QImode
  V8HImode,                /* config/aarch64/aarch64-modes.def:42 */
#define HAVE_V8HImode
  V4SImode,                /* config/aarch64/aarch64-modes.def:42 */
#define HAVE_V4SImode
  V2DImode,                /* config/aarch64/aarch64-modes.def:42 */
#define HAVE_V2DImode
  V32QImode,               /* config/aarch64/aarch64-modes.def:57 */
#define HAVE_V32QImode
  V16HImode,               /* config/aarch64/aarch64-modes.def:57 */
#define HAVE_V16HImode
  V8SImode,                /* config/aarch64/aarch64-modes.def:57 */
#define HAVE_V8SImode
  V4DImode,                /* config/aarch64/aarch64-modes.def:57 */
#define HAVE_V4DImode
  V2TImode,                /* config/aarch64/aarch64-modes.def:57 */
#define HAVE_V2TImode
  V48QImode,               /* config/aarch64/aarch64-modes.def:60 */
#define HAVE_V48QImode
  V24HImode,               /* config/aarch64/aarch64-modes.def:60 */
#define HAVE_V24HImode
  V12SImode,               /* config/aarch64/aarch64-modes.def:60 */
#define HAVE_V12SImode
  V6DImode,                /* config/aarch64/aarch64-modes.def:60 */
#define HAVE_V6DImode
  V3TImode,                /* config/aarch64/aarch64-modes.def:60 */
#define HAVE_V3TImode
  V2EImode,                /* config/aarch64/aarch64-modes.def:60 */
#define HAVE_V2EImode
  V64QImode,               /* config/aarch64/aarch64-modes.def:63 */
#define HAVE_V64QImode
  V32HImode,               /* config/aarch64/aarch64-modes.def:63 */
#define HAVE_V32HImode
  V16SImode,               /* config/aarch64/aarch64-modes.def:63 */
#define HAVE_V16SImode
  V8DImode,                /* config/aarch64/aarch64-modes.def:63 */
#define HAVE_V8DImode
  V4TImode,                /* config/aarch64/aarch64-modes.def:63 */
#define HAVE_V4TImode
  V2OImode,                /* config/aarch64/aarch64-modes.def:63 */
#define HAVE_V2OImode
  V2SFmode,                /* config/aarch64/aarch64-modes.def:43 */
#define HAVE_V2SFmode
  V1DFmode,                /* config/aarch64/aarch64-modes.def:45 */
#define HAVE_V1DFmode
  V4SFmode,                /* config/aarch64/aarch64-modes.def:44 */
#define HAVE_V4SFmode
  V2DFmode,                /* config/aarch64/aarch64-modes.def:44 */
#define HAVE_V2DFmode
  V8SFmode,                /* config/aarch64/aarch64-modes.def:58 */
#define HAVE_V8SFmode
  V4DFmode,                /* config/aarch64/aarch64-modes.def:58 */
#define HAVE_V4DFmode
  V12SFmode,               /* config/aarch64/aarch64-modes.def:61 */
#define HAVE_V12SFmode
  V6DFmode,                /* config/aarch64/aarch64-modes.def:61 */
#define HAVE_V6DFmode
  V16SFmode,               /* config/aarch64/aarch64-modes.def:64 */
#define HAVE_V16SFmode
  V8DFmode,                /* config/aarch64/aarch64-modes.def:64 */
