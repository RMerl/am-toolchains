...
enum opt_code
{
  ...
  OPT_mabi_ = 1136,                          /* -mabi= */
  OPT_march_ = 1137,                         /* -march= */
  OPT_mbig_endian = 1138,                    /* -mbig-endian */
  OPT_mbionic = 1139,                        /* -mbionic */
  OPT_mcmodel_ = 1140,                       /* -mcmodel= */
  OPT_mcpu_ = 1141,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1142,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1143,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1144,             /* -mgeneral-regs-only */
  OPT_mglibc = 1145,                         /* -mglibc */
  OPT_mlittle_endian = 1146,                 /* -mlittle-endian */
  OPT_mmusl = 1147,                          /* -mmusl */
  ...
  OPT_nostartfiles = 1158,                   /* -nostartfiles */
  OPT_nostdinc = 1159,                       /* -nostdinc */
  OPT_nostdinc__ = 1160,                     /* -nostdinc++ */
  OPT_nostdlib = 1161,                       /* -nostdlib */
  OPT_o = 1162,                              /* -o */
  OPT_p = 1163,                              /* -p */
  OPT_pass_exit_codes = 1164,                /* -pass-exit-codes */
  /* OPT_pedantic = 1165, */                 /* -pedantic */
  OPT_pedantic_errors = 1166,                /* -pedantic-errors */
  OPT_pg = 1167,                             /* -pg */
  OPT_pie = 1168,                            /* -pie */
  OPT_pipe = 1169,                           /* -pipe */
  OPT_posix = 1170,                          /* -posix */
  ...
  OPT_profile = 1182,                        /* -profile */
  OPT_pthread = 1183,                        /* -pthread */
  OPT_quiet = 1184,                          /* -quiet */
  OPT_r = 1185,                              /* -r */
  OPT_rdynamic = 1186,                       /* -rdynamic */
  OPT_remap = 1187,                          /* -remap */
  OPT_s = 1188,                              /* -s */
  OPT_s_bc_abi = 1189,                       /* -s-bc-abi */
  OPT_save_temps = 1190,                     /* -save-temps */
  OPT_save_temps_ = 1191,                    /* -save-temps= */
  OPT_shared = 1192,                         /* -shared */
  OPT_shared_libgcc = 1193,                  /* -shared-libgcc */
  /* OPT_specs = 1194, */                    /* -specs */
  OPT_specs_ = 1195,                         /* -specs= */
  OPT_static = 1196,                         /* -static */
  OPT_static_libasan = 1197,                 /* -static-libasan */
  OPT_static_libgcc = 1198,                  /* -static-libgcc */
  OPT_static_libgcj = 1199,                  /* -static-libgcj */
  OPT_static_libgfortran = 1200,             /* -static-libgfortran */
  OPT_static_libgo = 1201,                   /* -static-libgo */
  OPT_static_liblsan = 1202,                 /* -static-liblsan */
  OPT_static_libmpx = 1203,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1204,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1205,               /* -static-libstdc++ */
  OPT_static_libtsan = 1206,                 /* -static-libtsan */
  OPT_static_libubsan = 1207,                /* -static-libubsan */
  /* OPT_std_c__03 = 1208, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1209, */                /* -std=c++0x */
  OPT_std_c__11 = 1210,                      /* -std=c++11 */
  OPT_std_c__14 = 1211,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1212, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1213, */                /* -std=c++1y */
  OPT_std_c__1z = 1214,                      /* -std=c++1z */
  OPT_std_c__98 = 1215,                      /* -std=c++98 */
  OPT_std_c11 = 1216,                        /* -std=c11 */
  /* OPT_std_c1x = 1217, */                  /* -std=c1x */
  /* OPT_std_c89 = 1218, */                  /* -std=c89 */
  OPT_std_c90 = 1219,                        /* -std=c90 */
  OPT_std_c99 = 1220,                        /* -std=c99 */
  /* OPT_std_c9x = 1221, */                  /* -std=c9x */
  OPT_std_f2003 = 1222,                      /* -std=f2003 */
  OPT_std_f2008 = 1223,                      /* -std=f2008 */
  OPT_std_f2008ts = 1224,                    /* -std=f2008ts */
  OPT_std_f95 = 1225,                        /* -std=f95 */
  OPT_std_gnu = 1226,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1227, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1228, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1229,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1230,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1231, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1232, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1233,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1234,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1235,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1236, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1237, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1238,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1239,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1240, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1241, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1242,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1243, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1244, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1245, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1246,                     /* -std=legacy */
  OPT_symbolic = 1247,                       /* -symbolic */
  OPT_t = 1248,                              /* -t */
  OPT_time = 1249,                           /* -time */
  OPT_time_ = 1250,                          /* -time= */
  OPT_traditional = 1251,                    /* -traditional */
  OPT_traditional_cpp = 1252,                /* -traditional-cpp */
  OPT_trigraphs = 1253,                      /* -trigraphs */
  OPT_u = 1254,                              /* -u */
  OPT_undef = 1255,                          /* -undef */
  OPT_v = 1256,                              /* -v */
  OPT_version = 1257,                        /* -version */
  OPT_w = 1258,                              /* -w */
  OPT_wrapper = 1259,                        /* -wrapper */
  OPT_x = 1260,                              /* -x */
  OPT_z = 1261,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
