...
enum opt_code
{
  ...
  OPT_mandroid = 1598,                       /* -mandroid */
  OPT_mapcs = 1599,                          /* -mapcs */
  OPT_mapcs_frame = 1600,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1601,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1602,              /* -mapcs-stack-check */
  OPT_march_ = 1603,                         /* -march= */
  OPT_marm = 1604,                           /* -marm */
  OPT_masm_syntax_unified = 1605,            /* -masm-syntax-unified */
  OPT_mbe32 = 1606,                          /* -mbe32 */
  OPT_mbe8 = 1607,                           /* -mbe8 */
  OPT_mbig_endian = 1608,                    /* -mbig-endian */
  OPT_mbionic = 1609,                        /* -mbionic */
  OPT_mbranch_cost_ = 1610,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1611,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1612,     /* -mcaller-super-interworking */
  OPT_mcmse = 1613,                          /* -mcmse */
  OPT_mcpu_ = 1614,                          /* -mcpu= */
  OPT_mfdpic = 1615,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1616,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1617,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1618,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1619,                  /* -mfp16-format= */
  OPT_mfpu_ = 1620,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1621,             /* -mgeneral-regs-only */
  OPT_mglibc = 1622,                         /* -mglibc */
  /* OPT_mhard_float = 1623, */              /* -mhard-float */
