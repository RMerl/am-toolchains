...
#define __GMP_CC "/tools/oss/packages/x86_64-rhel6/gcc/4.8.3/bin/gcc -std=gnu99"
#define __GMP_CFLAGS "-O2 -I/auto/tool_build/bintools_04/crosstools-arm_softfp-gcc-10.3-linux-4.19-glibc-2.32-binutils-2.36.1/include"
